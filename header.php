            ...
            <div class="entete__contenu">
                <div class="entete__contact">
                    <a href="#" class="btn_menu">Nous contacter
                        <svg class="icone_contact" width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M7 12L17 12" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <div class="entete__menu">
                    ...
                    <svg class="icone_burger burger_rotation" viewBox="0 0 100 100">
                            <path
                                  class="trait haut"
